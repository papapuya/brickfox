      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="border-t pt-4">
              <h3 className="font-semibold mb-3">🔑 Automatischer Login (optional)</h3>
              <p className="text-xs text-muted-foreground mb-4">
                System sendet Login-Formulardaten automatisch und verwendet Cookies für Scraping
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="https://lieferant.de/login"
                  />
                  <p className="text-xs text-muted-foreground mt-1">
                    Die URL, an die das Login-Formular gesendet wird
                  </p>
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="loginUsernameField">Benutzername Feldname</Label>
                    <Input
                      id="loginUsernameField"
                      value={formData.loginUsernameField}
                      onChange={(e) => setFormData({ ...formData, loginUsernameField: e.target.value })}
                      placeholder="username / email / user"
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      Name des Login-Formularfelds
                    </p>
                  </div>

                  <div>
                    <Label htmlFor="loginPasswordField">Passwort Feldname</Label>
                    <Input
                    ...
                    />
                    <p className="text-xs text-muted-foreground mt-1">
                      Name des Passwort-Formularfelds
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                  <p className="text-xs text-blue-800">
                    ...
                    1. System sendet POST-Request mit Ihren Anmeldedaten an Login-URL<br/>
                    2. Empfängt Session-Cookies von der Antwort<br/>
                    3. Verwendet diese Cookies automatisch für alle Scraping-Anfragen<br/>
                    4. Kein manuelles Cookie-Management erforderlich!
                  </p>
                </div>
              </div>
            </div>
