...
export const PRODUCT_CATEGORIES: Record<string, ProductCategoryConfig> = {
  battery: {
    ...
    technicalFields: [
      ...
      { key: 'maxChargeCurrent', label: 'Max. Ladestrom', unit: 'mA', required: false },
      { key: 'maxDischargeCurrent', label: 'Max. Entladestrom', unit: 'A', required: false },
      { key: 'current', label: 'Stromstärke', unit: 'A', required: false },
      { key: 'dimensions', label: 'Maße', unit: 'mm', required: false },
      { key: 'abmessungen', label: 'Abmessungen', unit: 'mm', required: false },
